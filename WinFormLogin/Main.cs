...
namespace WinFormLogin
{
    public partial class Main : Form
    {
        ...
        {
            if (ValidarNoVacio(txtNombre.Text, "Nombre")   && ValidarNoVacio(txtApellido.Text, "Apellido") && ValidarNumerico(txtDni.Text, "DNI") && ValidarNumerico(txtEdad.Text, "Edad") && ValidarNumerico(txtNumHabitacion.Text, "Numero de Habitación"))
            {
        ...
        protected virtual bool ValidarNumerico(string input, string fieldName)
        {
            ...
            {
                if(fieldName=="Edad" || fieldName == "Numero de habitacion" || fieldName == "DNI")
                {
                ...
                {
                    MessageBox.Show($"El valor ingresado para {fieldName} no es válido. No debe contener números.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return true;
                }
            }
            return true;
